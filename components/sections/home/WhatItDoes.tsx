...
export default function WhatItDoes() {
  ...
  return (
    <section
      ...
      className="w-full bg-wid-section-bg py-16 md:py-24 lg:py-32"
    >
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* ── Section Heading ────────────────────────────────── */}
        <div
          ref={sectionRef}
          className={`mb-12 text-center transition-all duration-700 ease-out motion-reduce:transition-none md:mb-16 lg:mb-20 ${
            sectionVisible
        ...
        >
          {/* Overline */}
          <p className="mb-3 text-xs font-semibold tracking-widest text-wid-accent-purple uppercase sm:text-sm">
            Why Axiler
          </p>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
          ...
          {/* Right Card — Autonomous Platform */}
          <div
            ref={rightCardRef}
